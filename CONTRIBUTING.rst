...
MARBLE could always use more documentation, whether as part of the
official MARBLE docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
3. The pull request should work for Python 3.4, 3.5, and 3.6. Check
   https://travis-ci.org/mcgibbon/marble/pull_requests
